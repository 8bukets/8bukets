...
def scrape_companylink():
    url = "https://companylink.business.blog/"
    ...
    try:
        ...
        signature = "All the best - https://companylink.business.blog/"
        sections.append({
            "header": "Signature",
            "content": signature
        })
        ...
        data = {
            "source": url,
            "title": title,
            "description": "Market intelligence and company news updates extracted from companylink.business.blog.",
        ...
        output_path = os.path.join(output_dir, "companylink_knowledge.json")
