...
def rollout():
    ...
    try:
        ...
        run_command(["npm", "install"], cwd="software-review-platform/backend")
        run_command(["npm", "install"], cwd="software-review-platform/frontend")
        ...
        # In a real environment, this might be: run_command(["vercel", "--prod"], cwd="software-review-platform/frontend")
        ...
        # run_command(["npm", "run", "db:seed"], cwd="software-review-platform/backend")
        ...
        # run_command(["npm", "test"], cwd="software-review-platform/backend")
