...
const checks = [
  ...
  },
  {
    ...
    pattern: /resonanceLatency: number = 0 .* Neural Resonance/,
  ...
  {
    name: 'Universal Mesh Routing (UMR-v3)',
    file: 'antigravity/services/universal_mesh_routing.ts',
    pattern: /UMR-v3\.0/,
    description: 'Universal Mesh Routing must be upgraded to v3.0 for Phase 27.'
  }
];
