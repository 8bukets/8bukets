...
def scrape_webshop():
    url = "https://webshop.business.blog/"
    ...
    try:
        ...
        signature = "All the best - https://webshop.business.blog/"
        sections.append({
            "header": "Signature",
            "content": signature
        })
        ...
        data = {
            "source": url,
            "title": title,
            "description": "Market intelligence and webshop updates extracted from webshop.business.blog.",
            "topKeywords": ["webshop", "market", "intelligence", "business", "updates"],
        ...
        output_path = os.path.join(output_dir, "webshop_knowledge.json")
