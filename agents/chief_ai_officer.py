            ...
            for s in sections_list:
                if isinstance(s, dict):
                    ...
                    if isinstance(content_val, list):
                        contents.extend([str(item).lower() for item in content_val])
                    else:
                        contents.append(str(content_val).lower())
                elif isinstance(s, list):
                    contents.extend([str(item).lower() for item in s])
                else:
                    contents.append(str(s).lower())
            sections_content = " ".join(contents)
