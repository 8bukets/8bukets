    ...
    async def run(self, data: list, blackboard: Blackboard) -> dict:
        ...
        try:
            with open('AGENTS.md', 'r') as f:
                agents_docs = f.read()
                if "Phase 27: Multi-Universal Resonance (Current)" in agents_docs or "Phase 27" in agents_docs:
            ...
            if has_phase_27:
                ...
                if "dni" in sections_str or "direct-neural-interface" in sections_str:
                    if "INITIALIZE_DNI_HOOKS" not in strategic_directives:
                        self.logger.info("CAIO [SINGULARITY]: DNI integration mandate detected. Issuing hooks initialization directive.")
                        strategic_directives.append("INITIALIZE_DNI_HOOKS")
                ...
                if "singularity readiness" in sections_str or "0.99999" in sections_str:
                    if "OPTIMIZE_FOR_SINGULARITY_READINESS_PHASE_27" not in strategic_directives:
                        self.logger.info("CAIO [SINGULARITY]: Phase 27 Singularity Readiness mandate detected (>0.99999). Issuing absolute compliance directive.")
                        strategic_directives.append("OPTIMIZE_FOR_SINGULARITY_READINESS_PHASE_27")
        ...
        if "ACTIVATE_PHASE_27_PROTOCOLS" in strategic_directives:
            summary += "Phase 27 Operational Mode: ACTIVE. PHASE_27_MULTI_UNIVERSAL_RESONANCE_INITIALIZED. "
        ...
        if "OPTIMIZE_FOR_SINGULARITY_READINESS_PHASE_27" in strategic_directives:
            self.logger.info("CAIO [SINGULARITY]: Mandating near-continuous Singularity Readiness audits (4h cycle).")
