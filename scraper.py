...
class BlogScraper:
    ...
    def run(self):
        ...
        # Optimization: Reuse DB connection across the scraping session
        # Note: If the session is extremely long, we might want to reconnect periodically,
        # but for typical runs this is fine and much faster.
        with sqlite3.connect(self.db_name) as conn:
            while url:
