...
class BlogScraper:
    def __init__(self, base_url, output_json="wishlist_data.json", db_name="wishlist_data.db"):
        ...
        # Optimization: Reuse Session and DB Connection
    ...
    def save_to_db(self, item):
        ...
        try:
            ...
            if existing_post:
                # With row_factory, we can access by index or name, but fetchone returns Row object which acts like tuple too
                post_id = existing_post[0]
                old_title = existing_post[1]
                old_link = existing_post[2]
                updated = False
