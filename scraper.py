...
def parse_page(html: str) -> List[Dict]:
    """Parse HTML and extract posts. Synchronous function for CPU offloading."""
...
class MarkPositionScraperAsync:
    ...
    async def scrape(self):
        ...
        # This allows parallel parsing on multiple cores, avoiding GIL blocking the event loop
    ...
    async def fetch_and_parse(self, session, page_num, sem, pool):
        async with sem:
            ...
            if html:
                # Run CPU-bound parsing in the process pool
