...
class OracleNewsScraper:
    ...
    def parse_page(self, html: str) -> List[Dict]:
        """Parse HTML to extract news posts, handling hidden content in comments."""
        # Optimization: Use regex to find the comment instead of parsing full HTML with BS4
        # This is significantly faster (~1000x) as we avoid building the DOM for the whole page
        news_html = None

        # Regex to find comments. Non-greedy match.
