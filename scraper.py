...
Scrapes articles, extracts metadata, and saves to JSON, CSV, and TXT.
"""
import argparse
import asyncio
import csv
...
class MarkPositionScraperAsync:
    """Scraper class to fetch and parse pages asynchronously."""
    def __init__(
        self,
        output_json: str,
        output_csv: str,
    ...
    def _extract_post_data(self, article) -> Dict:
    ...
    async def scrape(self):
        ...
        async with aiohttp.ClientSession(headers=headers) as session:
            ...
            while active:
                ...
                logger.info("Fetching pages %s to %s...",
