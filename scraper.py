...
class MarkPositionScraperAsync:
    ...
    async def parse_page(self, html: str) -> List[Dict]:
        # Optimize parsing by only looking for article tags with class 'post'
        # This significantly speeds up parsing by ignoring the rest of the HTML tree
        # Use regex to match 'post' as a whole word in class attribute because class can be multiple values
