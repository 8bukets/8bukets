...
class MarkPositionScraperAsync:
    ...
    async def parse_page(self, html: str) -> List[Dict]:
        ...
        for article in articles:
            ...
            # Author
            # Optimization: Use find(class_='fn') instead of CSS selector
            # The class 'fn' (Full Name) is part of the vcard microformat and should be unique enough within the article context
