...
Uses aiohttp for concurrent fetching and BeautifulSoup for parsing.
"""
...
class MarkPositionScraperAsync:
    """Async scraper for MarkPosition WordPress site."""
        ...
        async with aiohttp.ClientSession(headers=headers) as session:
            ...
            while active:
                ...
                for i in range(current_concurrency):
                    ...
                    # (though sem is less useful if we just create batch size = concurrency)
