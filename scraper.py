...
def parse_page(html: str) -> List[Dict]:
    """Parse HTML content to extract posts data.

    Uses SoupStrainer to only parse article tags, optimizing performance.
    """
    # Use regex to match 'post' in multi-valued class attribute
...
class MarkPositionScraperAsync:
    ...
    async def scrape(self):
        ...
        # limiting workers to concurrency level is a reasonable default
            ...
            async with aiohttp.ClientSession(headers=headers) as session:
                ...
                while active:
                    ...
                    for i in range(current_concurrency):
                        ...
                        tasks.append(self.fetch_and_parse(session, current_page, sem, executor, loop))
    ...
    async def fetch_and_parse(self, session, page_num, sem, executor, loop):
        async with sem:
