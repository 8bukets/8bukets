...
def parse_page_content(html: str) -> List[Dict]:
    """
    Parse the HTML content of a page and extract articles.
...
class MarkPositionScraperAsync:
    def __init__(self, output_json: str, output_csv: str, output_txt: str, max_pages: Optional[int] = None, concurrency: int = 5):
        ...
        self.session = None
        # Initialize ProcessPoolExecutor for CPU-bound parsing
        # Optimization: Offload parsing to processes to avoid blocking the asyncio event loop.
    ...
    async def parse_page(self, html: str) -> List[Dict]:
        ...
        return await loop.run_in_executor(self.pool, parse_page_content, html)
