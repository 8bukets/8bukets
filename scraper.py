...
class MarkPositionScraperAsync:
    ...
    async def parse_page(self, html: str) -> List[Dict]:
        # Optimization: Use SoupStrainer to only parse 'article' tags with 'post' in the class.
        # This significantly reduces parsing time by ignoring the rest of the document.
        # Note: We use a regex because class_ in SoupStrainer performs an exact match, but we need partial match.
