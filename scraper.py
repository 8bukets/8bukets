...
class MarkPositionScraperAsync:
    def __init__(self, output_json: str, output_csv: str, output_txt: str, max_pages: Optional[int] = None, concurrency: int = 5):
        ...
        self.session = None
        # Compile regex for SoupStrainer to match 'post' class even if other classes exist
        self.article_strainer = SoupStrainer('article', class_=re.compile(r'\bpost\b'))
    ...
    def parse_page(self, html: str) -> List[Dict]:
        # Use SoupStrainer to only parse article tags, reducing memory and CPU usage
        soup = BeautifulSoup(html, 'lxml', parse_only=self.article_strainer)
