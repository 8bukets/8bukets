"""
Scraper for markposition.wordpress.com using aiohttp and BeautifulSoup.
Optimized with SoupStrainer and lxml.
"""
import asyncio
import json
import csv
...
class MarkPositionScraperAsync:
    ...
    async def fetch_page(self, session: aiohttp.ClientSession, page_num: int) -> Optional[str]:
        """Fetch a single page by page number."""
    ...
    async def parse_page(self, html: str) -> List[Dict]:
        ...
        # Optimization: Use SoupStrainer and lxml to only parse article tags
    ...
    def save_data(self, posts: List[Dict]):
        """Save scraped data to JSON, CSV and TXT."""
        # JSON
        try:
