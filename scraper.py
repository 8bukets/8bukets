...
class OracleNewsScraper:
    ...
    def parse_page(self, html: str) -> List[Dict]:
        # Optimize: Use regex to find the specific comment instead of parsing the whole DOM
        # This is significantly faster (~268x) for finding a specific comment block
        news_html = None
        # Pattern to find HTML comments: <!-- content -->
        # We look for a comment containing 'rc92v0' and '<section'
        # Using finditer with DOTALL to handle newlines
