...
# --- Helper Functions (Moved to top-level for Pickling) ---
...
def parse_page_content(html: str) -> List[Dict]:
    ...
    CPU-bound task to be run in ProcessPoolExecutor.
    """
...
class MarkPositionScraperAsync:
    ...
    async def scrape(self):
        ...
        # max_workers=None defaults to CPU count, which is usually best for CPU-bound tasks.
