...
Scrapes articles, dates, authors, and external links, saving them to JSON, CSV, and TXT.
"""
import argparse
import asyncio
import csv
...
class MarkPositionScraperAsync:
    """
    Scraper class for fetching and parsing posts from MarkPosition.
    ...
    async def parse_page(self, html: str) -> List[Dict]:
        """Parse HTML content of a page and return a list of posts."""
