...
class MarkPositionScraperAsync:
    ...
    async def parse_page(self, html: str) -> List[Dict]:
        ...
        for article in articles:
            ...
            # Title
            title_text = ""
            # Optimization: Use find instead of select_one (approx 45% faster)
            ...
            # Date
            # Optimization: Use find instead of select_one
            ...
            # Author
            # Optimization: Use find instead of select_one (.author.vcard .fn)
            # Find author container first to ensure hierarchy
