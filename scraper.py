...
class OracleNewsScraper:
    ...
    async def parse_page(self, html: str) -> List[Dict]:
        # Optimization: Use SoupStrainer to parse only <a> tags.
        # This significantly reduces parsing time by ignoring the rest of the document structure.
        # SoupStrainer('a', href=True) preserves the subtree of the matched tags,
        # so we can still find nested <h3> tags.
