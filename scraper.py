...
class MarkPositionScraperAsync:
    ...
    async def parse_page(self, html: str) -> List[Dict]:
        # Optimization: Use SoupStrainer to parse only 'article' tags, skipping irrelevant HTML.
        # This significantly reduces parsing time and memory usage.
        ...
        for article in articles:
            ...
            # Title
            title_text = ""
            # Optimization: Use find() instead of select_one() to avoid CSS selector overhead.
            ...
            author_tag = author_div.find(class_='fn') if author_div else None
            if author_tag:
