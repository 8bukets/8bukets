...
def parse_html(html: str) -> List[Dict]:
    ...
    Optimized with SoupStrainer and intended to run in a separate process.
    """
    ...
    # Since we strained, the soup contains the relevant article tags.
    # We find them all to iterate.
            ...
            async with aiohttp.ClientSession(headers=headers) as session:
                ...
                while active:
                    ...
                    for i in range(current_concurrency):
                        ...
                        tasks.append(self.fetch_and_parse(session, current_page, sem, pool))
