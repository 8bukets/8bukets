...
class OracleNewsScraper:
    ...
    async def parse_page(self, html: str) -> List[Dict]:
        ...
        # This significantly reduces parsing time for large HTML documents.
        ...
        # When using parse_only with SoupStrainer('a'), soup itself acts like the collection of filtered tags
        # or we can use soup.find_all('a') which works on the filtered tree.
