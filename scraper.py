...
class MarkPositionScraperAsync:
    ...
    def parse_page(self, html: str) -> List[Dict]:
        ...
        This is CPU-bound and should be run in a thread executor to avoid blocking the event loop.
        """
    ...
    async def fetch_and_parse(self, session, page_num) -> Tuple[int, Optional[List[Dict]]]:
        ...
        if html:
            # ⚡ Bolt Optimization: Run CPU-bound parsing in a thread to keep the event loop non-blocking
