 ...
 */ async function validateInstantConfigs(accumulatedChunks, debugChunks, startTime, rootParams, fallbackRouteParams, ctx, hmrRefreshHash, validationSamples) {
    ...
    async function validateAtDepthImpl(depth, groupDepthForValidation, previousBoundaryState) {
        ...
        try {
            ...
            const { preludeIsEmpty } = await (0, _streamops.processPrelude)(unprocessedPrelude);
            result = (0, _dynamicrendering.getNavigationDisallowedDynamicReasons)(workStore, preludeIsEmpty ? _dynamicrendering.PreludeState.Empty : _dynamicrendering.PreludeState.Full, instantValidationState, validationSampleTracking, boundaryState);
        } catch (thrownValue) {
            result = (0, _dynamicrendering.getNavigationDisallowedDynamicReasons)(workStore, _dynamicrendering.PreludeState.Errored, instantValidationState, validationSampleTracking, boundaryState);
        }
