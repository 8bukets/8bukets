...
export async function handleFallback(config, failedModel, authType, error) {
    ...
    try {
        ...
        return await processIntent(config, intent, fallbackModel, failedModel !== activeModel ? failedModel : undefined);
    }
    catch (handlerError) {
...
async function processIntent(config, intent, fallbackModel, failedModel) {
    switch (intent) {
        case 'retry_always':
