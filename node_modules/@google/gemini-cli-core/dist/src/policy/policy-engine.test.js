...
vi.mock('../utils/shell-utils.js', async (importOriginal) => {
    ...
    return {
        ...
        parseCommandDetails: vi.fn().mockImplementation((command) => {
        ...
        stripShellWrapper: vi.fn().mockImplementation((command) => {
...
describe('PolicyEngine', () => {
    ...
    describe('check', () => {
        ...
        it('should fail closed in YOLO mode when shell parsing fails for restricted rule', async () => {
            ...
            vi.mocked(parseCommandDetails).mockImplementationOnce((command) => {
            ...
            const { decision } = await engine.check({ name: 'run_shell_command', args: { command: 'echo bypass' } }, undefined);
            expect(decision).toBe(PolicyDecision.DENY);
        });
    ...
    describe('shell command parsing failure', () => {
        ...
        it('should NOT downgrade to ASK_USER for redirected commands in YOLO mode even without sandbox', async () => {
            ...
            const { decision } = await engine.check({ name: 'run_shell_command', args: { command } }, undefined);
            expect(decision).toBe(PolicyDecision.ALLOW);
        });
