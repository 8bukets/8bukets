...
export declare class PolicyEngine {
     ...
     */
    check(toolCall: FunctionCall, serverName: string | undefined, toolAnnotations?: Record<string, unknown>, subagent?: string, skipHeuristics?: boolean): Promise<CheckResult>;
    /**
