...
import { SHELL_TOOL_NAMES, REDIRECTION_NAMES, initializeShellParsers, parseCommandDetails, stripShellWrapper, hasRedirection, extractStringFromParseEntry, } from '../utils/shell-utils.js';
...
export class PolicyEngine {
    ...
    async checkShellCommand(toolName, command, ruleDecision, serverName, dir_path, allowRedirection, rule, toolAnnotations, subagent) {
        ...
        let responsibleRule = rule && ruleDecision === rule.decision ? rule : undefined;
        ...
        for (const detail of subCommands) {
            ...
            if (!isAtomic) {
                ...
                if (subResult.decision === PolicyDecision.ALLOW &&
