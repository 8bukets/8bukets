...
describe('formatNodesForLlm', () => {
    ...
    it('should format tool calls correctly', () => {
        ...
        const result = formatNodesForLlm(nodes);
        expect(result).toContain('[Turn 0] [MODEL] [TOOL_EXECUTION]: CALL: run_shell_command({"cmd":"ls"})');
    });
    it('should format tool responses with semantic wrappers', () => {
        ...
        const result = formatNodesForLlm(nodes);
        expect(result).toContain('[Turn 0] [USER] [TOOL_EXECUTION]: [SHELL EXECUTION (run_shell_command)]: {"output":"file.txt"}');
    });
...
//# sourceMappingURL=formatNodesForLlm.test.js.map