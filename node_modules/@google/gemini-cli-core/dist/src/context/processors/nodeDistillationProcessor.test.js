...
describe('NodeDistillationProcessor', () => {
    it('should trigger summarization via LLM for long text parts', async () => {
        ...
        const prompt = createDummyNode('ep1', NodeType.USER_PROMPT, 50, {
            payload: { text: longText },
        }, 'prompt-id');
        const thought = createDummyNode('ep1', NodeType.AGENT_THOUGHT, 50, {
            payload: { text: longText },
        }, 'thought-id');
    ...
    it('should ignore nodes that are below the threshold', async () => {
        ...
        const prompt = createDummyNode('ep1', NodeType.USER_PROMPT, 10, {
            payload: { text: shortText },
        }, 'prompt-id');
        const thought = createDummyNode('ep1', NodeType.AGENT_THOUGHT, 13, {
