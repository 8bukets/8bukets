...
import { getResponseText, updatePart, cloneFunctionResponse, } from '../../utils/partUtils.js';
                    ...
                    case NodeType.TOOL_EXECUTION: {
                        if (payload.functionResponse) {
                            ...
                            if (stringifiedObs.length > thresholdChars) {
                                const summary = await generateSummary(stringifiedObs, payload.functionResponse.name || 'unknown');
                                ...
                                const oldObsTokens = env.tokenCalculator.estimateTokensForParts([payload]);
