...
import { createSyntheticHistory, createMockContextConfig, setupContextComponentTest, deriveStableId, } from './testing/contextTestUtils.js';
describe('ContextManager Sync Pressure Barrier Tests', () => {
    ...
    it('should instantly truncate history when maxTokens is exceeded using truncate strategy', async () => {
        ...
        const contentNodes = projection.filter((p) => p.content.parts &&
