...
describe('ContextTracer (Real FS & Mock ID Gen)', () => {
    ...
    it('initializes, logs events, and auto-saves large assets deterministically', async () => {
        ...
        const traceLogPath = path.join(tmpDir, 'context_trace', 'test-session', 'trace.log');
        ...
        vi.advanceTimersByTime(10);
        await Promise.resolve();
        const expectedAssetPath = path.join(tmpDir, 'context_trace', 'test-session', 'assets', '1767268800020-mock-uuid-1-largeKey.json');
