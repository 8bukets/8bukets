...
describe('ContextWorkingBufferImpl', () => {
    it('should initialize with a pristine graph correctly', () => {
        ...
        const pristine2 = createDummyNode('ep1', NodeType.AGENT_THOUGHT, 10, undefined, 'p2');
    ...
    it('should track N:1 abstractions (e.g., rolling summaries)', () => {
        ...
        const summaryNode = createDummyNode('ep1', NodeType.ROLLING_SUMMARY, 15, undefined, 's1');
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    it('should handle net-new injected nodes without throwing', () => {
        const p1 = createDummyNode('ep1', NodeType.USER_PROMPT, 10, undefined, 'p1');
        let buffer = ContextWorkingBufferImpl.initialize([p1]);
        const injected = createDummyNode('ep1', NodeType.SYSTEM_EVENT, 5, undefined, 'injected1');
