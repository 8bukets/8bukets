...
export declare class PipelineOrchestrator {
    ...
    private readonly pipelineScheduled;
    private nodeProvider;
    constructor(pipelines: PipelineDef[], asyncPipelines: AsyncPipelineDef[], env: ContextEnvironment, tracer: ContextTracer);
    /**
    ...
    executeTriggerSync(trigger: PipelineTrigger, nodes: readonly ConcreteNode[], triggerTargets: ReadonlySet<string>, protectedTurnIds?: ReadonlySet<string>): Promise<readonly ConcreteNode[]>;
    private executeTriggerAsync;
    private handleAsyncExecution;
    shutdown(): void;
}
