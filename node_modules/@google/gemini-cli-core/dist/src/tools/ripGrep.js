...
import { resolveToRealPath, shortenPath, makeRelative, isTrustedSystemPath, } from '../utils/paths.js';
...
class GrepToolInvocation extends BaseToolInvocation {
    ...
    async execute({ abortSignal: signal }) {
        try {
            ...
            const result = await formatGrepResults(allMatches, this.params, searchLocationDescription, totalMaxMatches);
            return {
                ...result,
                display: {
