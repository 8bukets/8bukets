 ...
 */
export function resetGeminiMdFilename(filename = DEFAULT_CONTEXT_FILENAME) {
    const filenames = Array.isArray(filename) ? filename : [filename];
    const cleaned = Array.from(new Set(filenames
...
export function getProjectMemoryIndexFilePath(storage) {
