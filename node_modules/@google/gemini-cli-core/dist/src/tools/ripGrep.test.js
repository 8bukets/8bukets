...
import { RipGrepTool, resolveRipgrepPath, } from './ripGrep.js';
...
function createMockConfig(rootDir, workspaceDirs = [rootDir]) {
    const config = {
...
describe('RipGrepTool', () => {
    ...
    describe('advanced search options', () => {
        ...
        it('should add .geminiignore when enabled and patterns exist', async () => {
            ...
            vi.spyOn(configWithGeminiIgnore, 'getFileFilteringOptions').mockReturnValue({
                respectGitIgnore: true,
                respectGeminiIgnore: true,
                customIgnoreFilePaths: [],
            });
        ...
        it('should skip .geminiignore when disabled', async () => {
            ...
            vi.spyOn(configWithoutGeminiIgnore, 'getFileFilteringOptions').mockReturnValue({
                respectGitIgnore: true,
    ...
    describe('Path Fallback Logic', () => {
        ...
        describe('on POSIX', () => {
            ...
            it('should resolve the SEA (vendor subdirectory) path if purely flattened is missing', async () => {
                vi.mocked(fileExists).mockImplementation(async (checkPath) => checkPath.includes(path.normalize('vendor/ripgrep')));
                const resolvedPath = await resolveRipgrepPath();
                expect(resolvedPath).not.toBeNull();
