...
import { type InboxMemoryPatchKind } from '../services/memoryPatchUtils.js';
 ...
 */
export declare function listInboxMemoryPatches(config: Config): Promise<InboxMemoryPatch[]>;
/**
 ...
 */
export declare function applyInboxMemoryPatch(config: Config, kind: InboxMemoryPatchKind, relativePath: string): Promise<{
    success: boolean;
    message: string;
}>;
/**
 ...
 */
export declare function dismissInboxMemoryPatch(config: Config, kind: InboxMemoryPatchKind, relativePath: string): Promise<{
    success: boolean;
    message: string;
}>;
/**
