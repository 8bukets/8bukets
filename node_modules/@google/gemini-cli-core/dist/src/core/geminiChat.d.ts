...
export declare class GeminiChat {
    ...
    constructor(context: AgentLoopContext, systemInstruction?: string, tools?: Tool[], history?: Array<Content | HistoryTurn>, resumedSessionData?: ResumedSessionData, onModelChanged?: ((modelId: string) => Promise<Tool[]>) | undefined);
     ...
     * ```
     */
    sendMessageStream(modelConfigKey: ModelConfigKey, message: PartListUnion, prompt_id: string, signal: AbortSignal, role: LlmRole, displayContent?: PartListUnion, apiHistoryOverride?: Content[]): Promise<AsyncGenerator<StreamEvent>>;
     ...
     */
    getHistoryTurns(curated?: boolean): HistoryTurn[];
    /**
...
export declare function stripToolCallIdPrefixes(contents: Content[]): Content[];
