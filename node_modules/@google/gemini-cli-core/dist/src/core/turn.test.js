...
describe('Turn', () => {
    ...
    describe('run', () => {
        it('should yield content events for text parts', async () => {
            ...
            expect(mockSendMessageStream).toHaveBeenCalledWith({ model: 'gemini' }, reqParts, 'prompt-id-1', expect.any(AbortSignal), 'main', undefined, undefined);
        ...
        it('should yield tool_call_request events for function calls', async () => {
            ...
            expect(event2.value.callId).toEqual(expect.stringMatching(/^tool2__tool2_\d{13}_\d+$/));
