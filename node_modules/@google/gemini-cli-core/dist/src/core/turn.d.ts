 ...
 */
import { type Content, type PartListUnion, type GenerateContentResponse, type FunctionDeclaration, type FinishReason, type GenerateContentResponseUsageMetadata } from '@google/genai';
...
export declare class Turn {
    ...
    private hasLoggedRagTrace;
    constructor(chat: GeminiChat, prompt_id: string);
    run(modelConfigKey: ModelConfigKey, req: PartListUnion, signal: AbortSignal, options?: {
