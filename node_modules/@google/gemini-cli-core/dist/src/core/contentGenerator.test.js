...
import { createContentGenerator, AuthType, createContentGeneratorConfig, getAuthTypeFromEnv, } from './contentGenerator.js';
...
describe('createContentGeneratorConfig', () => {
    ...
    it('should include Vertex AI routing settings in content generator config', async () => {
        ...
        const config = await createContentGeneratorConfig(mockConfig, AuthType.USE_VERTEX_AI, undefined, undefined, undefined, vertexAiRouting);
    ...
    it('should configure for GATEWAY using provided apiKey if available', async () => {
        const config = await createContentGeneratorConfig(mockConfig, AuthType.GATEWAY, 'custom-gateway-key');
