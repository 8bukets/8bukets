...
export declare class GeminiClient {
    ...
    dispose(): void;
    resumeChat(history: ReadonlyArray<Content | HistoryTurn>, resumedSessionData?: ResumedSessionData): Promise<void>;
    getChatRecordingService(): ChatRecordingService | undefined;
    getLoopDetectionService(): LoopDetectionService;
    getCurrentSequenceModel(): string | null;
    addDirectoryContext(): Promise<void>;
    updateSystemInstruction(): void;
    startChat(extraHistory?: ReadonlyArray<Content | HistoryTurn>, resumedSessionData?: ResumedSessionData): Promise<GeminiChat>;
    private getIdeContextParts;
    private _getActiveModelForCurrentTurn;
    private processTurn;
    sendMessageStream(request: PartListUnion, signal: AbortSignal, prompt_id: string, turns?: number, displayContent?: PartListUnion, stopHookActive?: boolean): AsyncGenerator<ServerGeminiStreamEvent, Turn>;
