 ...
 */
import { z } from 'zod';
import { ACTIVATE_SKILL_TOOL_NAME, EDIT_TOOL_NAME, GLOB_TOOL_NAME, GREP_TOOL_NAME, LS_TOOL_NAME, READ_FILE_TOOL_NAME, WRITE_FILE_TOOL_NAME, } from '../tools/tool-names.js';
 ...
 * directory.
 */
export const SkillExtractionAgent = (skillsDir, sessionIndex, existingSkillsSummary, memoryDir = skillsDir.replace(/[/\\]skills$/, ''), 
/**
