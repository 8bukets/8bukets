 ...
 * directory.
 */
export declare const SkillExtractionAgent: (skillsDir: string, sessionIndex: string, existingSkillsSummary: string, memoryDir?: string, 
/**
 ...
 */
pendingInboxSummary?: string) => LocalAgentDefinition<typeof SkillExtractionSchema>;
export {};
