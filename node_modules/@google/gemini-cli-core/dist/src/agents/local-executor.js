...
import { createScopedWorkspaceContext, runWithScopedAutoMemoryExtractionWriteAccess, runWithScopedMemoryInboxAccess, runWithScopedWorkspaceContext, } from '../config/scoped-config.js';
...
export class LocalAgentExecutor {
    ...
    async run(inputs, signal) {
        ...
        const runWithInboxScope = () => this.definition.memoryInboxAccess
    ...
    async runInternal(inputs, signal) {
        ...
        try {
            ...
            try {
                ...
                const environmentMemory = this.definition.includeExtensionContext === false
