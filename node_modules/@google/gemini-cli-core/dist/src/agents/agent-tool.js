...
export class AgentTool extends BaseDeclarativeTool {
    ...
    constructor(context, messageBus, onAgentEvent) {
    ...
    createInvocation(params, messageBus, _toolName, _toolDisplayName) {
        ...
        return new DelegateInvocation(params, mappedInputs, messageBus, definition, this.context, _toolName, _toolDisplayName, this.onAgentEvent);
    }
...
class DelegateInvocation extends BaseToolInvocation {
    ...
    onAgentEvent;
    startIndex;
    constructor(params, mappedInputs, messageBus, definition, context, _toolName, _toolDisplayName, onAgentEvent) {
    ...
    buildChildInvocation(agentArgs) {
        ...
        if (this.definition.kind === 'remote') {
            if (useSession) {
                return new RemoteSessionInvocation(this.definition, this.context, agentArgs, this.messageBus, options);
            }
            return new RemoteAgentInvocation(this.definition, this.context, agentArgs, this.messageBus);
        }
        else {
            if (useSession) {
                return new LocalSessionInvocation(this.definition, this.context, agentArgs, this.messageBus, options);
            }
