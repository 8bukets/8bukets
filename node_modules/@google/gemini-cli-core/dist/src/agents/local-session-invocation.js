...
import { AgentTerminateMode, SubagentActivityErrorType, SUBAGENT_REJECTED_ERROR_PREFIX, SUBAGENT_CANCELLED_ERROR_MESSAGE, isToolActivityError, SubagentState, } from './types.js';
...
export class LocalSessionInvocation extends BaseToolInvocation {
     ...
     */
    constructor(definition, context, params, messageBus, options) {
        super(params, messageBus, options?.toolName ?? definition.name, options?.toolDisplayName ?? definition.displayName);
    ...
    async execute(options) {
            ...
            switch (activity.type) {
                ...
                case 'ERROR': {
                    ...
                    const callId = activity.data['callId']
                        ...
                        : undefined;
                    if (callId) {
                        const targetStatus = isCancellation || isRejection
                    ...
                    recentActivity.push({
                        ...
                        status: isCancellation || isRejection
                            ? SubagentState.CANCELLED
                            : SubagentState.ERROR,
                    });
                    updated = true;
        ...
        const session = new LocalSubagentSession(this.definition, this.context, this.messageBus, onActivity);
...
//# sourceMappingURL=local-session-invocation.js.map