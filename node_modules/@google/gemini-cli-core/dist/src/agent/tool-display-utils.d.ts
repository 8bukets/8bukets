 ...
 */
export declare function populateToolDisplay({ name, invocation, resultDisplay, displayName, display: prevDisplay, }: {
    name: string;
 ...
 */
export declare function displayContentToString(display: DisplayContent | undefined | null): string | undefined;
