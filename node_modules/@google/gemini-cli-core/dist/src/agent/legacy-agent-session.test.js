...
describe('LegacyAgentSession', () => {
    ...
    describe('send', () => {
        ...
        it('records the sent user message in the trajectory before send resolves', async () => {
            ...
            expect(sendMock).toHaveBeenCalledWith([{ text: 'hi' }], expect.any(AbortSignal), 'test-prompt', undefined, 'raw input');
    ...
    describe('stream - tool calls', () => {
        it('handles a tool call round-trip', async () => {
            ...
            expect(toolResp?.display).toEqual(expect.objectContaining({
                name: 'read_file',
