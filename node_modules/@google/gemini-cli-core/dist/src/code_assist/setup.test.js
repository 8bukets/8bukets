...
import { ProjectIdRequiredError, setupUser, ValidationCancelledError, InvalidNumericProjectIdError, resetUserDataCacheForTesting, } from './setup.js';
...
describe('setupUser', () => {
    ...
    describe('existing user', () => {
        ...
        it('should throw InvalidNumericProjectIdError when GOOGLE_CLOUD_PROJECT is numeric', async () => {
            ...
            await expect(setupUser({}, mockConfig)).rejects.toThrow(InvalidNumericProjectIdError);
        });
