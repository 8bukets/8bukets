 ...
 */
const RESERVED_SESSION_DIR_NAMES = new Set([
    CHATS_DIR,
    LOGS_DIR,
    TOOL_OUTPUTS_DIR,
]);
...
export async function deleteSessionArtifactsAsync(sessionId, tempDir) {
    try {
        ...
        const hasSeparator = safeSessionId.includes(path.sep) ||
 ...
 */
export function deriveSessionShortId(sessionIdOrBasename) {
 ...
 */
export async function getMatchingSessionFiles(chatsDir, shortId) {
 ...
 */
export async function deleteSessionFileAndArtifacts(chatsDir, file, tempDir) {
 ...
 */
export async function deleteStoredSession(config, sessionIdOrBasename) {
    try {
