...
describe('CoreEventEmitter', () => {
    ...
    describe('drainBacklogs Transformation', () => {
        it('should transform events during drain', () => {
            ...
            expect(listener).toHaveBeenCalledWith(expect.objectContaining({ isStderr: true, chunk: 'stdout chunk' }));
            expect(listener).toHaveBeenCalledWith(expect.objectContaining({ message: 'info message' }));
        });
        it('should drop events when transform returns undefined', () => {
            ...
            expect(listener).toHaveBeenCalledTimes(1);
            expect(listener).toHaveBeenCalledWith(expect.objectContaining({ message: 'keep me' }));
        });
    });
