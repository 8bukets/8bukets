 ...
 */
export declare function hardenHistory(history: HistoryTurn[], options?: HardeningOptions): HistoryTurn[];
/**
 ...
 */
export declare function scrubHistory(history: HistoryTurn[]): HistoryTurn[];
/**
 * Deep-scrubs an array of Content objects to remove non-standard properties.
 */
export declare function scrubContents(contents: Content[]): Content[];
export declare function scrubPart(part: Part): Part;
