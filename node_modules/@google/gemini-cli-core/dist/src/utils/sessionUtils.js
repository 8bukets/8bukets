 ...
 */
export function ensureStableToolIds(history) {
        ...
        for (let partIdx = 0; partIdx < parts.length; partIdx++) {
            ...
            if (part.functionCall && !part.functionCall.id) {
                ...
                if (nextTurn?.content.role === 'user') {
                    const matchingResp = nextTurn.content.parts?.find((p) => p.functionResponse &&
            ...
            if (part.functionResponse && !part.functionResponse.id) {
                ...
                if (prevTurn?.content.role === 'model') {
                    const matchingCall = prevTurn.content.parts?.find((p) => p.functionCall &&
