...
export const ALL_EDITORS = EDITORS;
...
export const EDITOR_OPTIONS = EDITORS.map((e) => ({ value: e, label: EDITOR_DISPLAY_NAMES[e] }));
 ...
 */
export function resolveEditorTypeFromCommand(command) {
    const lowerCmd = command.toLowerCase();
    for (const editor of EDITORS) {
        const { win32, default: nonWin32 } = editorCommands[editor];
        if (win32.some((c) => c.toLowerCase() === lowerCmd) ||
 ...
 */
export function getEditorExtraArgs(editor, options) {
