...
import { hardenHistory, SYNTHETIC_THOUGHT_SIGNATURE, } from './historyHardening.js';
...
describe('hardenHistory', () => {
    ...
    it('should successfully match parallel tool calls and responses even if responses are originally split across separate user turns', () => {
        ...
        expect(userResponseTurn.content.parts[0].functionResponse?.response).toEqual({ ok: true });
        expect(userResponseTurn.content.parts[1].functionResponse?.response).toEqual({ ok: true });
    });
    it('should synthesize a functionCall for a singleton orphaned functionResponse', () => {
        ...
        expect(modelTurn.content.parts[1]
            .thoughtSignature).toBe(SYNTHETIC_THOUGHT_SIGNATURE);
...
//# sourceMappingURL=historyHardening.test.js.map