...
import { safeLiteralReplace, truncateString, safeTemplateReplace, isBinary, stripAnsiFromBuffer, } from './textUtils.js';
...
describe('isBinary', () => {
    ...
    describe('PTY mode (isPtyOutput = true)', () => {
        ...
        it('returns false for realistic Windows PTY output with ANSI reset + text', () => {
            ...
            const buf = Buffer.from('\x1b[?25l\x1b]0;\x00Window Title\x07\x1b[0mPS C:\\Users> echo hello\r\nhello\r\n');
            expect(isBinary(buf, 512, true)).toBe(false);
        });
