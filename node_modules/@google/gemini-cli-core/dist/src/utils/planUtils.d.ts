 ...
 */
export declare function resolveAndValidatePlanPath(planPath: string, plansDir: string, projectRoot: string): string;
/**
 ...
 */
export declare function validatePlanPath(planPath: string, plansDir: string, projectRoot: string): Promise<string | null>;
/**
