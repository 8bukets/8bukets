...
import { escapeShellArg, getCommandRoots, getShellConfiguration, initializeShellParsers, parseCommandDetails, splitCommands, stripShellWrapper, stripHupGuard, BASH_HUP_GUARD, normalizeCommand, hasRedirection, resolveExecutable, } from './shell-utils.js';
...
describe('getShellConfiguration', () => {
    ...
    describe('on Windows', () => {
        ...
        it.skipIf(!isWindowsRuntime)('should prefer pwsh.exe over powershell.exe when pwsh is available in PATH', () => {
...
describe('stripShellWrapper (with HUP guard integration)', () => {
    ...
    it('should strip the HUP guard alone when no shell wrapper', () => {
        expect(stripShellWrapper(`${BASH_HUP_GUARD} git status`)).toBe('git status');
    });
