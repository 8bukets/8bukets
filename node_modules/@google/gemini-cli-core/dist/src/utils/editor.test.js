...
import { hasValidEditorCommand, hasValidEditorCommandAsync, getDiffCommand, openDiff, allowEditorTypeInSandbox, isEditorAvailable, isEditorAvailableAsync, isValidEditorType, getEditorWaitFlag, getEditorExtraArgs, resolveEditorAsync, resolveEditorTypeFromCommand, } from './editor.js';
...
describe('editor utils', () => {
    ...
    describe('getDiffCommand', () => {
        ...
        it('should return the correct command for emacsclient with escaped paths', () => {
            const command = getDiffCommand('old file "quote".txt', 'new file \\back\\slash.txt', 'emacsclient');
            expect(command).toEqual({
                command: 'emacsclient',
                args: [
                    '-nw',
