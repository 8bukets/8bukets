...
import { escapePath, unescapePath, isSubpath, shortenPath, normalizePath, resolveToRealPath, makeRelative, deduplicateAbsolutePaths, toAbsolutePath, toPathKey, isTrustedSystemPath, } from './paths.js';
...
describe('normalizePath', () => {
    ...
    describe('isTrustedSystemPath', () => {
        ...
        it('should allow trusted paths on Windows', () => {
            ...
            expect(isTrustedSystemPath('C:\\Program Files (x86)\\ripgrep\\rg.exe')).toBe(true);
            // Case insensitive
            expect(isTrustedSystemPath('c:\\windows\\system32\\rg.exe')).toBe(true);
            // Untrusted paths
        ...
        it('should allow trusted paths on macOS and Linux', () => {
            ...
            expect(isTrustedSystemPath('/opt/homebrew/Cellar/ripgrep/13.0.0/bin/rg')).toBe(true);
        ...
        it('should allow 1P internal hermetic execution paths', () => {
            ...
            expect(isTrustedSystemPath('/google/src/cloud/user/workspace/bazel-out/k8-fastbuild/bin/rg')).toBe(true);
            expect(isTrustedSystemPath('/google/src/cloud/user/workspace/blaze-out/k8-opt/bin/rg')).toBe(true);
        });
