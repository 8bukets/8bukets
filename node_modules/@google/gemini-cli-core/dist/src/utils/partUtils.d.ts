 ...
 */
export declare function cloneFunctionResponse(resp: NonNullable<Part['functionResponse']>): NonNullable<Part['functionResponse']>;
/**
 * Safely clones a FunctionCall object.
 */
export declare function cloneFunctionCall(call: NonNullable<Part['functionCall']>): NonNullable<Part['functionCall']>;
