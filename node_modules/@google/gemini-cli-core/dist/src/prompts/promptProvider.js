...
import { getAllGeminiMdFilenames, getGlobalMemoryFilePath, getProjectMemoryIndexFilePath, } from '../tools/memoryTool.js';
/**
        ...
        if (systemMdResolution.value && !systemMdResolution.isDisabled) {
            ...
            const options = {
                ...
                planningWorkflow: this.withSection('planningWorkflow', () => ({
                    interactive: interactiveMode,
                    planModeToolsList,
                    plansDir: makeRelative(context.config.storage.getPlansDir(), context.config.getProjectRoot()).replaceAll('\\', '/'),
                    approvedPlanPath: (() => {
                        const approvedPath = context.config.getApprovedPlanPath();
                        return approvedPath
                            ? makeRelative(approvedPath, context.config.getProjectRoot()).replaceAll('\\', '/')
                            : undefined;
                    })(),
                }), isPlanMode),
                operationalGuidelines: this.withSection('operationalGuidelines', () => ({
                    ...
                    topicUpdateNarration: isTopicUpdateNarrationEnabled,
                    userProjectMemoryPath: normalizePromptPath(getProjectMemoryIndexFilePath(context.config.storage)),
