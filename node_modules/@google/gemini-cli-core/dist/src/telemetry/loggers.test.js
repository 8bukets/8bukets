...
describe('loggers', () => {
    ...
    describe('logApiResponse', () => {
        ...
        it('should not log input and output messages when traces are disabled', () => {
            ...
            const event = new ApiResponseEvent('test-model', 100, { prompt_id: 'prompt-id-1', contents: [] }, { candidates: [] }, AuthType.LOGIN_WITH_GOOGLE, undefined, 'test-response');
            ...
            const detailsCall = emitCalls.find((call) => call[0].attributes &&
    ...
    describe('logApiError', () => {
        ...
        it('should not log input messages when traces are disabled', () => {
            ...
            const event = new ApiErrorEvent('test-model', 'error', 100, { prompt_id: 'prompt-id-1', contents: [] }, AuthType.LOGIN_WITH_GOOGLE, 'ApiError', 500);
