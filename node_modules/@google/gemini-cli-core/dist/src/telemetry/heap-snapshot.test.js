...
describe('heap-snapshot', () => {
    ...
    it('should return null and log an error if capture fails', () => {
        ...
        expect(debugLogger.error).toHaveBeenCalledWith(expect.stringContaining('Failed to capture heap snapshot'), expect.any(Error));
    });
});
//# sourceMappingURL=heap-snapshot.test.js.map