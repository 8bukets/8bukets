...
describe('getDisplayString', () => {
    ...
    it('should return the model name as is for other models', () => {
        ...
        expect(getDisplayString(GEMMA_4_26B_A4B_IT_MODEL)).toBe(GEMMA_4_26B_A4B_IT_MODEL);
...
describe('isActiveModel', () => {
    ...
    it('should return true for Gemma 4 models when experimentalGemma is not provided (defaults to true)', () => {
        ...
        expect(isActiveModel(GEMMA_4_31B_IT_MODEL, false, false, false, true)).toBe(true);
        expect(isActiveModel(GEMMA_4_26B_A4B_IT_MODEL, false, false, false, true)).toBe(true);
    });
...
describe('Gemini 3.1 Config Resolution', () => {
    it('PREVIEW_GEMINI_3_1_MODEL should resolve to chat-base-3 config (including thinkingLevel)', () => {
        ...
        expect(resolved.generateContentConfig?.thinkingConfig?.thinkingLevel).toBeDefined();
    });
