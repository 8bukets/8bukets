...
export function getAutoModelDescription(hasAccessToPreview, useGemini3_1 = false) {
 ...
 */
export function isActiveModel(model, useGemini3_1 = false, useGemini3_1FlashLite = false, useCustomToolModel = false, experimentalGemma = true) {
