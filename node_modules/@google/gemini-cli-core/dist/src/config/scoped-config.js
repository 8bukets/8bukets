...
const autoMemoryExtractionWriteAccessOverride = new AsyncLocalStorage();
/**
 ...
 */
export function hasScopedMemoryInboxAccess() {
 ...
 */
export function runWithScopedMemoryInboxAccess(fn) {
 ...
 */
export function hasScopedAutoMemoryExtractionWriteAccess() {
 ...
 */
export function runWithScopedAutoMemoryExtractionWriteAccess(fn) {
