...
export class ToolExecutor {
    ...
    createErrorResult(call, error, errorType, returnDisplay, tailToolCallRequest, display) {
        const response = this.createErrorResponse(call.request, error, errorType, returnDisplay, display);
        const startTime = 'startTime' in call ? call.startTime : undefined;
        return {
    ...
    createErrorResponse(request, error, errorType, returnDisplay, display) {
