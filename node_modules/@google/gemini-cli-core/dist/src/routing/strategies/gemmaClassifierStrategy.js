...
`;
    ...
    async route(context, config, _baseLlmClient, client) {
        ...
        try {
            ...
            const selectedModel = resolveClassifierModel(context.requestedModel ?? config.getModel(), routerResponse.model_choice, useGemini3_1, useGemini3_1FlashLite, useCustomToolModel, hasAccessToPreview, config);
            return {
                model: selectedModel,
                metadata: {
