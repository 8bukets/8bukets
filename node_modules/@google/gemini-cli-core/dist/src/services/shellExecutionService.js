...
import { getShellConfiguration, resolveExecutable, BASH_HUP_GUARD, } from '../utils/shell-utils.js';
...
function injectUtf8CodepageForPty(command, shell, isWindows, usingPty) {
...
export class ShellExecutionService {
    ...
    static async prepareExecution(commandToExecute, cwd, shellExecutionConfig, isInteractive, usingPty) {
        ...
        const hupGuarded = !isWindows
            ...
            : promptGuarded;
        const finalCommand = injectUtf8CodepageForPty(hupGuarded, shell, isWindows, usingPty);
    ...
    static async childProcessFallback(commandToExecute, cwd, onOutputEvent, abortSignal, shellExecutionConfig, isInteractive) {
        ...
        try {
            const isWindows = os.platform() === 'win32';
            const prepared = await this.prepareExecution(commandToExecute, cwd, shellExecutionConfig, isInteractive, false);
