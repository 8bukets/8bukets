...
describe('ShellExecutionService', () => {
    ...
    beforeEach(() => {
        ...
        mockResolveExecutable.mockImplementation((exe) => exe);
...
describe('ShellExecutionService child_process fallback', () => {
    ...
    describe('Platform-Specific Behavior', () => {
        it('should use powershell.exe on Windows', async () => {
            ...
            expect(mockCpSpawn).toHaveBeenCalledWith('powershell.exe', ['-NoProfile', '-NonInteractive', '-Command', 'dir "foo bar"'], expect.objectContaining({
                shell: false,
                detached: false,
