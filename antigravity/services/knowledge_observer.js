...
export class KnowledgeObserver {
    ...
    async persistKnowledge(newInsights) {
        ...
        let existingData = { typescript_sections: [] };
        ...
        if (!existingData.typescript_sections)
            existingData.typescript_sections = [];
    ...
    static processContent(title, raw, source) {
...
export function persistKnowledge(newInsights) {
    const observer = new KnowledgeObserver();
    return observer.persistKnowledge(newInsights);
}
export async function observeKnowledge(url) {
