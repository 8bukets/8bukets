...
export async function triggerJenkinsPipeline(jobName = 'antigravity-pipeline') {
...
export async function getJenkinsBuildStatus(jobName = 'antigravity-pipeline') {
