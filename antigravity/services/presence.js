...
export class OnlinePresenceService {
    ...
    isLeader() {
        var _a, _b;
        return (_b = (_a = this.lastPresence) === null || _a === void 0 ? void 0 : _a.is_leader) !== null && _b !== void 0 ? _b : false;
    }
    /**
    ...
    async syncPresence() {
        ...
        try {
            ...
            const providers = [];
            if (process.env.GITHUB_TOKEN || process.env.MACBOOK_CLOUD_SIMULATION === 'true')
                providers.push('github');
            if (process.env.GITLAB_TOKEN || process.env.MACBOOK_CLOUD_SIMULATION === 'true')
                providers.push('gitlab');
            if (process.env.MONGODB_URI || process.env.MACBOOK_CLOUD_SIMULATION === 'true')
                providers.push('mongodb');
            if (process.env.NEXT_PUBLIC_SUPABASE_URL || process.env.MACBOOK_CLOUD_SIMULATION === 'true')
            ...
            try {
                ...
                if (isCloud) {
                    ...
                    const macbookNode = otherNodes.find(n => { var _a, _b; return (((_a = n.telemetry) === null || _a === void 0 ? void 0 : _a.node_id) || ((_b = n['telemetry']) === null || _b === void 0 ? void 0 : _b.node_id)) === 'macbook-primary-01'; });
            ...
            try {
                const client = await getMongoClient();
                const db = client.db();
                await db.collection('agent_presence').updateOne({ agent: 'Jules', 'telemetry.node_id': nodeId }, { $set: presence }, { upsert: true });
            }
            catch (e) {
