  ...
  public start() {
    ...
    this.interval = setInterval(async () => {
      ...
      try {
        ...
        this.resonanceLatency = Math.random() * 0.007 // Target < 0.008ms (Phase 27)
        ...
        if (this.resonanceLatency > 0.008) {
           logAutonomousAction(`⚠️ [SwarmHeartbeat] Neural Resonance Latency violation: ${this.resonanceLatency}ms (Target < 0.008ms Phase 27)`, 'warning')
        }
      } catch (err: any) {
