...
def generate_report(data, output_file):
    ...
    md.append("- [Top 10 Referenced Domains](#top-referenced-domains)")
    ...
    md.append("\n## 🔗 Top 10 Referenced Domains <a name='top-referenced-domains'></a>")
    ...
    md.append("\n## 📂 Top 10 Categories <a name='top-categories'></a>")
