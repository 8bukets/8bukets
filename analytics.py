...
def generate_report(data, output_file):
    ...
    md.append("- [🌐 Top Domains](#domains)")
    md.append("- [📂 Top Categories](#categories)")
    md.append("- [📅 Timeline](#timeline)")
    ...
    md.append('\n## <a id="categories"></a>📂 Top 10 Categories')
    md.append("| Category | Count |")
    md.append("| :--- | :---: |")
    for cat, count in category_counts:
        md.append(f"| {cat} | {count} |")

    md.append('\n## <a id="timeline"></a>📅 Posts by Year')
