"""
Module for analyzing scraped data and generating a Markdown report.
"""
import json
import argparse
...
def generate_report(report_data, output_file):
    ...
    md.append("| ✅ Status | Analysis Complete |")
    ...
    md.append("\n<details>")
    md.append(
        "<summary><strong>📂 Detailed Statistics (Categories, Years, Authors)</strong></summary>\n"
    )
