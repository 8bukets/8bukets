...
def generate_report(data, output_file):
    ...
    # Note: Consuming generator into Counter. We keep the counter object to get total unique count later.
    domain_counter = Counter(domains)
    domain_counts = domain_counter.most_common(10)

    # 2. Category Analysis
    # Optimization: Use chain.from_iterable to avoid creating large intermediate list
