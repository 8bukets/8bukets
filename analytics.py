...
def generate_report(data, output_file):
    ...
    md.append(f"| 📅 Date Range | {start_date} to {end_date} | ℹ️ |")
    md.append(f"| 🌐 Unique Domains | {len(set(domains))} | 🔗 |")
    md.append(f"| 👥 Active Authors | {len(author_counts)} | ✍️ |")
    ...
    if author_counts:
        md.append(f"<details>")
        md.append(f"<summary>Click to view full author list ({len(author_counts)} authors)</summary>\n")
