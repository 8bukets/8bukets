...
def generate_report(data, output_file):
    ...
    md.append("<a id='general-statistics'></a>")
    md.append("\n## 📊 General Statistics")
    ...
    md.append("<a id='top-10-referenced-domains'></a>")
    ...
    md.append("<a id='top-10-categories'></a>")
    md.append("\n## 📂 Top 10 Categories")
    ...
    md.append("<a id='posts-by-year'></a>")
    md.append("\n## 📅 Posts by Year")
    ...
    md.append("<a id='authors'></a>")
    md.append("\n## ✍️ Authors")
    if len(author_counts) > 5:
        md.append("<details>")
        md.append("<summary>Click to expand authors list</summary>\n")
