...
def generate_biweekly_report(context, filename):
    try:
...
def run_cycle():
    ...
    generate_biweekly_report(context, report_file)

    logger.info("=== Cycle Complete ===")

def main():
    parser = argparse.ArgumentParser(description="Autonomous Agent System")
    parser.add_argument("--loop", action="store_true", help="Run continuously every 14 days")
