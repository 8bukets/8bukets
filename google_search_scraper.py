...
def perform_google_search(query: str, num_results: int = 10, lang: str = "en") -> List[Dict[str, str]]:
    ...
    # googlesearch-python's search function returns an iterator of URLs
    # It has advanced mode that returns more info (title, description)
    # search(term, num_results=10, lang="en", advanced=True)
