...
def save_daily_report(data):
    ...
    with open(report_file, "w", encoding="utf-8") as f:
        ...
        f.write("| :--- | :--- |\n")
        site_status_icon = "🟢" if status.get('site_status') == "healthy" else "🔴"
        f.write(f"| **Site Status** | {status.get('site_status')} {site_status_icon} |\n")
        f.write(f"| **Posts Scraped** | {research.get('posts_scraped')} 📄 |\n")
        f.write(f"| **Focus** | {intel.get('recommended_focus')} 🎯 |\n\n")
        ...
        if len(insights) > 5:
            f.write("<details>\n<summary>Click to view all insights</summary>\n\n")
