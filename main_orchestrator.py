...
def save_daily_report(data, report_dir="reports"):
    ...
    with open(report_file, "w", encoding="utf-8") as f:
        ...
        site_status = str(status.get('site_status')).lower()
        status_icon = "✅" if site_status == "healthy" else "❌"

        f.write("| Check | Status | Details |\n")
        f.write("| :--- | :---: | :--- |\n")
        f.write(f"| Site Status | {status_icon} | Code: {status.get('site_code')} |\n")
        f.write(f"| Robots.txt | {'✅' if status.get('robots_txt_accessible') else '❌'} | - |\n")
        f.write(f"| Googlebot | {'✅' if status.get('googlebot_allowed') else '❌'} | - |\n\n")
