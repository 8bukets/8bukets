...
def save_daily_report(data):
    ...
    with open(report_file, "w", encoding="utf-8") as f:
        ...
        status_emoji = "✅" if site_status == "healthy" else "❌"

        research = data.get('research', {})
        draft = data.get('content_draft', {})

        f.write("## 📊 Executive Summary\n")
        f.write("| Metric | Status/Value | Details |\n")
        f.write("| :--- | :--- | :--- |\n")
        f.write(f"| **System Health** | {status_emoji} {site_status.title()} "
                f"| Code: {status.get('site_code')} |\n")
        f.write(f"| **Research** | 🔎 {research.get('posts_scraped', 0)} Posts "
                f"| Google Results: {research.get('google_results', 0)} |\n")
        f.write(f"| **Content** | 📝 Draft Created | "
                f"'{draft.get('draft_title', 'Untitled')}' |\n\n")

        # Health
        f.write("## 1. System Health & Environment\n")
        f.write(f"- **Site Status:** {status_emoji} {site_status} "
                f"(Code: {status.get('site_code')})\n")
        ...
        f.write("<details>\n<summary><strong>View Detailed Insights</strong></summary>\n\n")
        ...
        f.write("<details>\n<summary><strong>View Monetization Details</strong></summary>\n\n")
        ...
        f.write("<details>\n<summary><strong>View Creative Ideas</strong></summary>\n\n")
