...
def save_daily_report(data):
    ...
    with open(report_file, "w", encoding="utf-8") as f:
        ...
        site_healthy = health.get('site_status') == "healthy"
        posts_count = research.get('posts_scraped', 0)
        evolution_status = intel.get('evolution_status', 'Unknown')

        # Executive Summary Table
        f.write("## 📊 Executive Summary\n\n")
        f.write("| Metric | Status | Details |\n")
        f.write("| :--- | :---: | :--- |\n")
        f.write(f"| **System Health** | {get_status_icon(site_healthy)} | {health.get('site_status')} (Code: {health.get('site_code')}) |\n")
        f.write(f"| **New Content** | 📝 | {posts_count} posts scraped |\n")
        f.write(f"| **Evolution** | 🧬 | {evolution_status} |\n\n")

        # 1. System Health
        f.write("## 1. System Health & Environment\n")
        f.write(f"- **Site Status:** {get_status_icon(site_healthy)} {health.get('site_status')}\n")
        f.write(f"- **Robots.txt Access:** {get_status_icon(health.get('robots_txt_accessible'))}\n")
        f.write(f"- **Googlebot Allowed:** {get_status_icon(health.get('googlebot_allowed'))}\n\n")

        # 2. Research Summary
        f.write("## 2. Research Summary\n")
        f.write(f"- **New Posts Scraped:** {posts_count}\n")
        ...
        f.write("<details>\n<summary><strong>4. Advertising & Targeting Details</strong></summary>\n\n")
        ...
        f.write("<details>\n<summary><strong>5. Monetization Review</strong></summary>\n\n")
        ...
        f.write("<details>\n<summary><strong>6. Creative Brainstorming</strong></summary>\n\n")
