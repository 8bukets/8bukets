...
def save_daily_report(data):
    ...
    with open(report_file, "w", encoding="utf-8") as f:
        ...
        f.write("- [1. System Health & Environment](#1-system-health--environment)\n")
        f.write("- [2. Research Summary](#2-research-summary)\n")
        f.write("- [3. Strategic Intelligence & Evolution](#3-strategic-intelligence--evolution)\n")
        f.write("- [4. Advertising & Targeting](#4-advertising--targeting-google-antigravity-colab)\n")
        f.write("- [5. Monetization Review](#5-monetization-review)\n")
        f.write("- [6. Creative Brainstorming](#6-creative-brainstorming)\n")
        f.write("- [7. Automated Content Draft](#7-automated-content-draft)\n\n")
