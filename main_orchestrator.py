...
def save_daily_report(data):
    ...
    with open(report_file, "w", encoding="utf-8") as f:
        ...
        f.write(f"*(Generated by Jules Autonomous Swarm with Continuous Learning at {timestamp})*\n\n")

        # Table of Contents
        f.write("## Table of Contents\n")
        f.write("- [1. System Health & Environment](#health)\n")
        f.write("- [2. Research Summary](#research)\n")
        f.write("- [3. Strategic Intelligence & Evolution](#intelligence)\n")
        ...
        f.write("- [7. Automated Content Draft](#content)\n\n")

        # Health
        f.write("<a name=\"health\"></a>\n")
        f.write("## 1. System Health & Environment\n")
        status = data.get('health', {})
        site_status = status.get('site_status')
        status_emoji = "✅" if site_status == "healthy" else "❌" if site_status == "unhealthy" else "⚠️"

        f.write(f"- **Site Status:** {status_emoji} {site_status} (Code: {status.get('site_code')})\n")
