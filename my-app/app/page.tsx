...
import { getRecentAnalytics } from "@/antigravity/services/analytics";
import { getNotifications } from "@/antigravity/services/notification";

export default async function CommandCenter({ params, searchParams }: PageProps) {
  'use cache'
  // We don't await dynamic request data at the top level to allow static shell generation in Next.js 16.
