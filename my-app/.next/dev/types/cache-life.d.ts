...
declare module 'next/cache' {
  ...
  export { unstable_noStore } from 'next/dist/server/web/spec-extension/unstable-no-store'
    ...
    /**
     * Cache this `"use cache"` for a timespan defined by the `"inventory"` profile.
     * ```
     *   stale:      30 seconds
     *   revalidate: 60 seconds (1 minute)
     ...
     */
    export function cacheLife(profile: "inventory"): void
    
    /**
     * Cache this `"use cache"` for a timespan defined by the `"catalog"` profile.
     * ```
     ...
     * If the server receives a new request after 4 hours, start revalidating new values in the background.
     * If this entry has no traffic for 1 day it will expire. The next request will recompute it.
     */
    export function cacheLife(profile: "catalog"): void
