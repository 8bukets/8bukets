...
![Unified Hub of your entire data estate and lifecycle](https://storage.googleapis.com/gweb-cloudblog-publish/original_images/1_Unified_Catalog.gif)
...
![Browsing a predefined list of agentic data engineering and science skills](https://storage.googleapis.com/gweb-cloudblog-publish/original_images/2_Agentic_Skills.gif)
...
![Within Data Agent Kit, you can use Conversational Analytics to explore your data](https://storage.googleapis.com/gweb-cloudblog-publish/original_images/3_Conversational_Analytics.gif)
...
![Click the Google Cloud icon in your activity bar to authenticate via IAM. Once logged in, your Cloud Storage, databases, and catalog assets appear instantly in your workspace.](https://storage.googleapis.com/gweb-cloudblog-publish/images/4_VS_Code_Marketplace_Extension.max-900x900.jpg)
...
![An intent-driven data engineering example](https://storage.googleapis.com/gweb-cloudblog-publish/images/5_Data_Agent_Kit_Extension_Installed.max-1400x1400.jpg)
...
![Ingestion into a bronze table](https://storage.googleapis.com/gweb-cloudblog-publish/original_images/6_Ingestion.gif)
...
![Data transformation to create silver and gold tables](https://storage.googleapis.com/gweb-cloudblog-publish/original_images/7_Transformation.gif)
...
![Machine learning and inference](https://storage.googleapis.com/gweb-cloudblog-publish/original_images/8_ML_Inferencing.gif)
...
![Orchestration pipelines and scheduling runs](https://storage.googleapis.com/gweb-cloudblog-publish/original_images/9_Orchestration.gif)
