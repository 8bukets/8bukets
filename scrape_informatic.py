...
def parse_post_html(post_soup, base_url: str) -> Post:
    ...
    if content_div:
        ...
        # Use MarkdownConverter directly with the soup object to avoid redundant string conversion and re-parsing.
        # This improves performance by skipping the step of serializing the soup to a string and then parsing it again.
