...
async def test_intelligence_agent_integration():
    ...
    await blackboard.update("MockResearch", {"research_data": {"market_trends": ["AI Expansion"], "external_investigations": [{"domain": "example.com", "world_context": "GOOGLE_WORLD"}]}})
    ...
    assert any("active node in the Google World" in i for i in insights)
